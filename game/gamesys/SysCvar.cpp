...
idCVar pm_thirdPersonRange(			"pm_thirdPersonRange",		"0",			CVAR_GAME | CVAR_FLOAT | CVAR_NORESET, "camera distance from player in 3rd person" );//80 to 0
idCVar pm_thirdPersonHeight(		"pm_thirdPersonHeight",		"600",			CVAR_GAME | CVAR_FLOAT | CVAR_NORESET, "height of camera from normal view height in 3rd person" );//50 to 200
...
idCVar pm_thirdPerson(				"pm_thirdPerson",			"1",			CVAR_GAME | CVAR_BOOL, "enables third person view" );//0 to 1
