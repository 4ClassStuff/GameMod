...
public:
	...
	virtual void		AttackHyperblaster			(bool altFire, int num_attacks, float spread, float fuseOffset, float power);
	virtual void		GetDebugInfo				( debugInfoProc_t proc, void* userData );
	...
	void				LaunchProjectilesMod		(idDict& dict, const idVec3& muzzleOrigin, const idMat3& muzzleAxis, int num_projectiles, float spread, float fuseOffset, float power);//Added
